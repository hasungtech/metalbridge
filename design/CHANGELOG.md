...
- `#intro` 신설: 아이브로 + H1 + 리드 + CTA 2개 + "저희가 대신하는 일" 4칸 + 사실 4줄
- 문구를 **문제 먼저**로 씀. 업체마다 전화 돌리고 같은 설명을 반복하고 재고 없다는 답을
  듣는 실제 업무를 먼저 적고, 그 일을 대신한다는 것을 H1 에 둠
- "저희가 대신하는 일" 4칸 — 사양 뽑아내기 / 빠진 항목 확인 / 여러 곳에 한 번에 /
  제각각인 회신을 한 장으로
